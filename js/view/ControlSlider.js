...
define( function( require ) {
  ...
  //strings
  var pattern_0value_1units = require( 'string!PULLEY/pattern_0value_1units' );


  // constants
  var TRACK_SIZE = new Dimension2( 190, 3 );
   ...
   * @constructor
   */
  function ControlSlider( title, units, trackProperty,  trackRange,
                          options ) {
    options = _.extend( {
      ...
      ticks: [
          {
            title: trackRange.min,
            value: trackRange.min
          },

          {
            title: trackRange.max,
...
*/
    ...
    trackProperty.link( function( value ) {
      valueLabel.text = StringUtils.format( pattern_0value_1units, trackProperty.value.toFixed(options.decimals), units);
